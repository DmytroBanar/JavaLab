...
public class Task1 extends JFrame {
    ...
    Task1() {
        ...
        executeButton.addActionListener(e -> outputField.setText(inputField.getText()));
        inputField.addActionListener(e -> outputField.setText("Введений текст: " + inputField.getText()));
